...
type Props = StackScreenProps<ExtensionShopStackParamList, 'CreateShopScreen'>;

const CreateShopScreen = ({ navigation }: Props) => {
    const [CII, setCII] = useState<string | undefined>('');
    const [shopName, setShopName] = useState("");
    const [shopImage, setShopImage] = useState<string | undefined>('');
    ...
    const handleSendShopConfirmation = async () => {
        ...
        try {
            ...
            axiosInstance.post(`/users/${store.getState().user.info?.id}/shop-confirmation/`, formData, {
                headers: {
